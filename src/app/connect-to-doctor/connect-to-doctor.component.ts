...
export class ConnectToDoctorComponent {
  originalDoctors = [
    { name: 'Dr. Nancy', picture: '../../assets/Doctor-images/Doctor_1.jpg', specialization: 'Pulmonary disease Expert', experience: 2, price: 300, rating: 4.5 },
    { name: 'Dr. Shreya', picture: '../../assets/Doctor-images/Doctor_2.jpg', specialization: 'Surgical Specalist', experience: 11, price: 400, rating: 4.7 },
    { name: 'Dr. Yash', picture: '../../assets/Doctor-images/Doctor_3.jpg', specialization: 'Radiologist', experience: 8, price: 500, rating: 4.1 },
